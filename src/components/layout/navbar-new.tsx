        ...
        <DropdownMenuContent align="end" className="w-48">
          {user ? (
            <>
              ...
              <DropdownMenuItem asChild>
                <Link href="/my-courses" className="w-full cursor-pointer">
                  My Courses
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
              ...
              {(user.role.includes("SELLER") ||
                ...
                <DropdownMenuItem asChild>
                  <Link
                    ...
                    className="w-full cursor-pointer font-semibold text-[#00d4ff]"
                  >
                    Seller Payments
                  </Link>
                </DropdownMenuItem>
  ...
  return (
    <>
      ...
      <Link href="/my-purchases">
        <Button
          variant="outline"
          className="w-full rounded-full border-white text-white hover:bg-white hover:text-black mb-2"
        >
          My Purchases
        </Button>
      </Link>
      ...
      {(user?.role.includes("SELLER") ||
        ...
        <Link href="/seller/payments">
          <Button
            variant="outline"
            className="w-full rounded-full border-[#00d4ff] text-[#00d4ff] hover:bg-[#00d4ff] hover:text-black mb-2"
          >
            Seller Payments
          </Button>
        </Link>
      ...
      {user?.role.includes("CURRICULUM_OFFICER") && (
        <Link href="/admin/curriculum">
          <Button
            variant="outline"
            className="w-full rounded-full border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white"
          >
            Curriculum Admin
          </Button>
        </Link>
  ...
  return (
    <header className="bg-black">
      <nav className="container mx-auto px-4 py-3 flex flex-wrap justify-between">
        ...
        <div
          className={`w-full lg:hidden pt-2 ${mobileMenuOpen ? "block" : "hidden"}`}
        >
          <ul className="flex flex-col space-y-4 pb-4">
            <li>
              <Link
                href="/"
                className={location === "/" ? "block text-[#00d4ff]" : "block"}
              >
                Home
              </Link>
            </li>
            <li>
              <Link
                href="/courses"
                className={
                  location === "/courses" ? "block text-[#00d4ff]" : "block"
                }
              >
                Certification
              </Link>
