...
import { Search, BookOpen, Clock, ChevronRight, Award, ThumbsUp, Loader2, DollarSign, BadgeIcon, Badge } from "lucide-react"
    ...
    return (
      <div className="w-full px-4 py-12">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center max-w-md mx-auto">
          ...
          <p className="text-red-600">{coursesError?.message || categoriesError?.message || "An error occurred"}</p>
    ...
    <div className="w-full px-4 py-12">
      ...
      <div className="relative rounded-xl overflow-hidden mb-12 max-w-[95%] mx-auto">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-center text-center px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">Education Courses</h1>
      ...
      {isLoading ? (
        ...
        <div className="bg-gray-50 rounded-lg shadow-sm p-6 text-center">
          ...
          <h2 className="text-2xl font-semibold mb-2 text-gray-800">No Courses Found</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-[95%] mx-auto">
          {filteredCourses.map((course: Course) => {
            return (
              <Card key={course.id} className="bg-gray-900 overflow-hidden border-gray-700">
                  ...
                  <CardHeader className="p-0">
                    <div className="relative h-48 w-full overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                        <CardTitle className="text-white p-4 w-full text-center">{category.name}</CardTitle>
                      </div>
                    </div>
                  </CardHeader>
      ...
      <div className="relative z-10">
        <h2 className="text-2xl font-bold mb-8 text-center text-gray-200">Benefits of Our Certification Courses</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden group hover:shadow-lg transition-all duration-300">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600">
                Learn from acclaimed dance educators with decades of professional experience.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden group hover:shadow-lg transition-all duration-300">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600">Enhance your teaching credentials and increase your earning potential.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-16 text-center bg-gradient-to-r from-blue-900 to-blue-700 py-12 px-6 rounded-xl shadow-lg max-w-[95%] mx-auto">
        <h2 className="text-2xl font-bold mb-4 text-white">Ready to Advance Your Dance Education?</h2>
        ...
        <Button
          ...
          onClick={() => {
            ...
            const coursesSection = document.querySelector(".grid-cols-1.sm\\:grid-cols-2.md\\:grid-cols-3")
            if (coursesSection) {
              window.scrollTo({
