...
import { Search, BookOpen, Clock, ChevronRight, Award, ThumbsUp, Loader2, DollarSign, BadgeIcon } from "lucide-react"
...
export default function CoursesPage() {
  ...
  return (
    <div className="w-full px-4 py-12">
      ...
      {/* Benefits Section */}
      <div className="mt-16 bg-gradient-to-r from-gray-100 to-gray-200 rounded-xl p-8 max-w-[95%] mx-auto">
        <h2 className="text-2xl font-bold mb-8 text-center text-gray-800">Benefits of Our Certification Courses</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden group hover:shadow-lg transition-all duration-300">
            <div className="h-48 overflow-hidden">
              <img
