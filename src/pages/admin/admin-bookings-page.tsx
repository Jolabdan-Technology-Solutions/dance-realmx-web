...
export default function AdminBookingsPage() {
  ...
  const { 
    ...
    queryFn: async () => {
      try {
        const res = await apiRequest("GET", "/api/admin/booking-professionals");
  ...
  const { 
    ...
    queryFn: async () => {
      try {
        const res = await apiRequest("GET", "/api/admin/booking-clients");
        return await res.json();
      } catch (error) {
  ...
  const confirmBookingAction = () => {
    if (bookingAction) {
      const newStatus = bookingAction.action === "confirm" ? "confirmed" : "cancelled";
  ...
  const filteredBookings = bookings.filter(booking => {
    ...
    if (timeFilter === "today") {
      ...
      matchesTime = !isPast(new Date(booking.startDate)) || isToday(new Date(booking.startDate));
          ...
          <TabsContent value="professionals" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage all professional dance instructors, choreographers and studios</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-col md:flex-row flex-wrap items-center gap-4 mb-6">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="choreographer">Choreographers</SelectItem>
                      ...
                      {isProfessionalsLoading ? (
                        ...
                        professionals.map((professional) => (
                          <TableRow key={professional.id}>
                              ...
                              <div className="flex items-center space-x-2">
                                <Avatar className="h-8 w-8">
                                  {professional.profileImageUrl ? (
                                    <AvatarImage src={professional.profileImageUrl} alt={professional.username} />
                                  ) : (
                                    <AvatarFallback>
                                      {professional.firstName?.charAt(0) || professional.username.charAt(0)}
                                    </AvatarFallback>
                                  )}
                                </Avatar>
                                <div>
                                  ...
                                  <p className="text-xs text-gray-400">{professional.email || "@" + professional.username}</p>
                                </div>
                              </div>
                            </TableCell>
                            <TableCell>
                            ...
                            <TableCell>{professional.danceStyles ? professional.danceStyles.join(", ") : "N/A"}</TableCell>
                            <TableCell>{professional.location || "N/A"}</TableCell>
                            ...
                            <TableCell>
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  ...
                                  <DropdownMenuItem>
                                    <Link href="/admin/users/1" className="flex items-center w-full">
                                      User Account
                                    </Link>
                                  </DropdownMenuItem>
                                </DropdownMenuContent>
              ...
              <TabsContent value="clients" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Manage all clients who book lessons and workshops</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="flex flex-col md:flex-row flex-wrap items-center gap-4 mb-6">
                      <div className="relative w-full md:w-64">
                        ...
                        <TableCell>
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              <DropdownMenuItem>View Bookings</DropdownMenuItem>
                              <DropdownMenuItem>
                                <Link href="/admin/users/4" className="flex items-center w-full">
                                  User Account
                                </Link>
                              </DropdownMenuItem>
                            </DropdownMenuContent>
          ...
          <TabsContent value="bookings" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Browse and manage all lesson and workshop bookings</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-col md:flex-row flex-wrap items-center gap-4 mb-6">
                  <div className="relative w-full md:w-64">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => setTimeFilter(value === "all" ? null : value)}
                  >
                    <SelectTrigger className="w-full md:w-40">
                            ...
                            currentBookings.map((booking) => (
                              <TableRow key={booking.id}>
                                <TableCell>
                                  <div className="max-w-xs">
                                    ...
                                    <div className="text-sm text-gray-400 flex items-center">
                                      {booking.danceStyle && (
                                        <><Tag className="h-3 w-3 mr-1" />{booking.danceStyle}</>
                                      )}
                                    </div>
                                  </div>
                                </TableCell>
                                ...
                                <TableCell>
                                  <div className="flex items-center space-x-2">
                                    <Avatar className="h-7 w-7">
                                      <AvatarImage src={booking.instructorImageUrl || undefined} alt={booking.instructorName} />
                                      <AvatarFallback>{getAvatarFallback(booking.instructorName)}</AvatarFallback>
                                    </Avatar>
                                ...
                                <TableCell>
                                  <div className="flex items-center space-x-2">
                                    <Avatar className="h-7 w-7">
                                      <AvatarImage src={booking.studentImageUrl || undefined} alt={booking.studentName} />
                                      <AvatarFallback>{getAvatarFallback(booking.studentName)}</AvatarFallback>
                                    </Avatar>
          ...
          <TabsContent value="today">
            <Card>
              ...
              <CardContent>
                ...
                <BookingList 
                  bookings={bookings.filter(booking => isToday(new Date(booking.startDate)))}
                  isLoading={isLoading}
          ...
          <TabsContent value="upcoming">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Future bookings across all instructors</CardDescription>
              </CardHeader>
              <CardContent>
                {/* Upcoming bookings filtered automatically in the component */}
                <BookingList 
                  bookings={bookings.filter(booking => !isPast(new Date(booking.startDate)) || isToday(new Date(booking.startDate)))}
                  isLoading={isLoading}
                  onViewBooking={handleViewBooking}
                  onActionBooking={handleBookingAction}
                />
          ...
          <TabsContent value="pending">
            <Card>
              ...
              <CardContent>
                ...
                <BookingList 
                  bookings={bookings.filter(booking => booking.status.toLowerCase() === "pending")}
                  isLoading={isLoading}
                  onViewBooking={handleViewBooking}
                  onActionBooking={handleBookingAction}
                />
              ...
              <div className="grid gap-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="mt-1">{formatDateTime(viewBooking.startDate)}</p>
                    {viewBooking.endDate && (
                  ...
                  <div>
                    ...
                    <p className="mt-1">{viewBooking.location || "Not specified"}</p>
                  </div>
                </div>
                
                <div>
                  <h3 className="text-sm font-medium text-gray-400">Description</h3>
                  <p className="mt-1">{viewBooking.description || "No description provided"}</p>
                </div>
                
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-sm font-medium text-gray-400">Instructor</h3>
                    <div className="flex items-center space-x-2 mt-1">
                      <Avatar className="h-8 w-8">
                        <AvatarImage src={viewBooking.instructorImageUrl || undefined} alt={viewBooking.instructorName} />
                        <AvatarFallback>{getAvatarFallback(viewBooking.instructorName)}</AvatarFallback>
                      </Avatar>
                      <div>
                        <p>{viewBooking.instructorName}</p>
                        {viewBooking.instructorEmail && (
                          <p className="text-sm text-gray-400">{viewBooking.instructorEmail}</p>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2 mt-1">
                      <Avatar className="h-8 w-8">
                        <AvatarImage src={viewBooking.studentImageUrl || undefined} alt={viewBooking.studentName} />
                        <AvatarFallback>{getAvatarFallback(viewBooking.studentName)}</AvatarFallback>
                      </Avatar>
                      <div>
                        <p>{viewBooking.studentName}</p>
                        {viewBooking.studentEmail && (
                          <p className="text-sm text-gray-400">{viewBooking.studentEmail}</p>
                        )}
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      {getPaymentBadge(viewBooking.paymentStatus) || "Not specified"}
                    </div>
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-gray-400">Dance Style</h3>
                    <p className="mt-1">{viewBooking.danceStyle || "Not specified"}</p>
                  </div>
                </div>
                ...
                {viewBooking.isPublic && (
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <h3 className="text-sm font-medium text-gray-400">Capacity</h3>
                      <p className="mt-1">{viewBooking.capacity || "Unlimited"}</p>
                    </div>
                    <div>
                      <h3 className="text-sm font-medium text-gray-400">Attendees</h3>
      ...
      <Dialog open={isActionDialogOpen} onOpenChange={setIsActionDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button
              variant={bookingAction?.action === "confirm" ? "default" : "destructive"}
            ...
            <div className="p-4 md:p-6 md:w-3/4">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  ...
                  <p className="text-gray-400">{booking.description || "No description provided"}</p>
                  ...
                  <div className="mt-3 space-y-2">
                    <div className="flex items-center">
                      ...
                      <Badge variant="outline" className="ml-1">Student</Badge>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <span>{booking.instructorName}</span>
                      <span className="mx-2 text-gray-500">•</span>
                      <Badge variant="outline" className="ml-1">Instructor</Badge>
                    </div>
