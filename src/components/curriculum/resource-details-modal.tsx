...
export const ResourceDetailsModal: React.FC<ResourceDetailsModalProps> = ({
  ...
  const previewVideoUrl = resource.previewVideoUrl ? convertToYouTubeEmbedUrl(resource.previewVideoUrl) : "";
            ...
            <DialogDescription className="flex items-center gap-2 text-sm mt-1">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-muted-foreground">
                  Published {formatDate(resource.createdAt || new Date().toISOString())}
                </span>
              </div>
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="relative rounded-lg overflow-hidden shadow-md mb-4">
                ...
                {hasPreviewVideo && (
                  ...
                  >
                    ...
                    <span className="absolute bottom-3 right-3 bg-black/70 text-white px-3 py-1 text-sm rounded-full">Preview Available</span>
                  </div>
                )}
              </div>
              ...
              <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 mb-4">
                <div className="flex justify-between items-center mb-3">
                  <div className="text-xl font-bold">
                    {parseFloat(resource.price) > 0 ? `$${parseFloat(resource.price).toFixed(2)}` : "Free"}
                  </div>
                  {resource.isFeatured && (
                ...
                <div className="space-y-3">
                  ...
                  {hasPreviewVideo && (
                    <Button variant="outline" className="w-full" onClick={() => setVideoModalOpen(true)}>
              ...
              <div className="space-y-3 text-sm">
                ...
                {resource.fileSize && (
                  <div className="flex items-center gap-2">
                    ...
                    <span>{Math.round((resource.fileSize / (1024 * 1024)) * 10) / 10} MB</span>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="md:col-span-3 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-x-6 gap-y-3">
                  {resource.danceStyle && (
                    <div>
                      <p className="font-medium text-sm text-muted-foreground">Dance Style</p>
                  ...
                  {resource.ageRange && (
                    <div>
                      <p className="font-medium text-sm text-muted-foreground">Age Range</p>
                  ...
                  {resource.format && (
                    <div>
                      <p className="font-medium text-sm text-muted-foreground">Format</p>
                      <p>{resource.format}</p>
                    </div>
                  )}
                </div>
