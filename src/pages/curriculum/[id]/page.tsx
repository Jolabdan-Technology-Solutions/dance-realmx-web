...
export default function CurriculumInfoPage() {
  ...
  const resourceId = (params?.id || params?.resourceId || params?.curriculum) as string
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-3">
            <div>
              ...
              <span className="ml-2 text-green-600 font-semibold">${resource.price}</span>
            </div>
            <div>
            ...
            <div>
              ...
              <span className="ml-2 capitalize">{resource.difficultyLevel.toLowerCase()}</span>
            </div>
          </div>
          <div className="space-y-3">
            <div>
              <span className="font-medium text-gray-700">Type:</span>
              <span className="ml-2 capitalize">{resource.type.toLowerCase()}</span>
            </div>
            <div>
              <span className="font-medium text-gray-700">Category:</span>
              <span className="ml-2">{resource.category?.name || `Category ${resource.categoryId}`}</span>
            </div>
            <div>
              <span className="font-medium text-gray-700">Created:</span>
              <span className="ml-2">{new Date(resource.created_at).toLocaleDateString()}</span>
            </div>
          </div>
        </div>
      </div>
