  ...
  useEffect(() => {
    const createSubscription = async () => {
      ...
      try {
        ...
        setErrorMessage(
          error.message || "There was a problem creating the subscription"
        );
      ...
      <div>
        ...
        <Card className="bg-gray-900 mb-6">
          ...
          <CardFooter className="flex flex-col items-start">
            ...
            <p className="text-sm text-gray-400">
              You can cancel or change your subscription at any time from your
              account settings.
            </p>
          </CardFooter>
        </Card>
        ...
        <Alert className="bg-gray-900 border-gray-800">
          ...
          <AlertDescription className="text-sm text-gray-400">
            Use the test card number 4242 4242 4242 4242, any future expiration
            date, any 3-digit CVC, and any postal code.
          </AlertDescription>
        </Alert>
      </div>
    </div>
